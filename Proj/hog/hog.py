...
def max_scoring_num_rolls(dice=six_sided, samples_count=1000):
    ...
    times = 1
    max_times = 1
    max_average = make_averaged(roll_dice, samples_count)(times, dice)
    while times < 10:
        times += 1
        average = make_averaged(roll_dice, samples_count)(times, dice)
...
def sus_strategy(score, opponent_score, threshold=11, num_rolls=6):
    ...
    # BEGIN PROBLEM 11
    add_score = sus_points(simple_update(0, score, opponent_score)) - score
